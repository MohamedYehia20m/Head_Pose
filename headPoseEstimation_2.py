...
if results.multi_face_landmarks:
    for face_landmarks in results.multi_face_landmarks:
        ...
        if left_ear is not None:
            cv2.putText(image, f'left_EAR: {left_ear:.2f}', (20, 75), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
        ...
        if right_ear is not None:
            cv2.putText(image, f'right_EAR: {right_ear:.2f}', (20, 150), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)

        # Calculate and draw Avg EAR
        avg_ear = (left_ear + right_ear) / 2
        if avg_ear is not None:
            cv2.putText(image, f'Avg EAR: {avg_ear:.2f}', (20, 225), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
        ...
        if yar is not None:
            cv2.putText(image, f'YAR: {yar:.2f}', (20, 300), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
